...
//        tryFreeButton.click();
        ...
        WebElement playButton = driver
                .findElement(By.cssSelector("button[data-testid='Play']"));
        playButton.click();
        ...
        // cssSelector for Enter key: button[aria-label='enter']
        keyEnter = driver
                .findElement(
                        By.cssSelector("button[aria-label='enter']"));
    ...
    public String getNextGuess(WebDriver driver, int currentRowNum) {
        ...
        // Selector for Row 1: #wordle-app-game > /html/body/div/div/div/main/div[1]/div/div[1]
        // Selector for Row 2: #wordle-app-game > /html/body/div/div/div/main/div[1]/div/div[2]
        //..
